        ...
        <div className="clearance_banner-over">
            <div className="clearance_section">
                ...
                <div className="clearance_order">
                    <p className="clearance_emphasis"><FontAwesomeIcon icon={faStore} style={{color: "black"}} /> in-store or <FontAwesomeIcon icon={faPhoneAlt} style={{color: "black"}} /> 0800 140 40 40</p>
